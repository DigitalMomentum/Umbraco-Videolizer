        ...
        function ($sce, $scope, editorService) {
            ...
            $scope.checkVideoUrl = function () {
                ...
                if ($scope.vidUrl !== "") {
                    ...
                    if (vidId !== false) {
                        ...
                        $scope.trustedEmbedUrl = $sce.trustAsResourceUrl("https://www.youtube.com/embed/" + vidId);
                    }
                    if ($scope.control.value === null) {
                        ...
                        if (vidId !== false) {
                            ...
                            $scope.trustedEmbedUrl = $sce.trustAsResourceUrl("https://player.vimeo.com/video/" + vidId);
                        }
                    }
            ...
            function onInit() {
                if ($scope.control.value !== null) {
                    if (typeof $scope.control.value.url !== "undefined") {
                        ...
                        $scope.trustedEmbedUrl = $sce.trustAsResourceUrl($scope.control.value.embedUrl);
                    } else {
            ...
            */
            ...
            function vimeoVidId(url) {
                ...
                p = /^(?:https?:\/\/)?(www\.|player\.)?vimeo.com\/(\d+)\/(.+)/;
                if (url.match(p)) {
