...
angular.module('umbraco')
    .controller('DigitalMomentum.Videolizer.PropertyEditor.VimeoSettings',
        function ($http, $scope, notificationsService, dialogService) {
            ...
            $scope.CheckServiceStatus = function () {
                ...
                var req = {
                    method: 'POST',
                    url: "/umbraco/backoffice/Plugins/Videolizer/Controllers/Settings/VimeoStatus",
                    headers: {
                        'Content-Type': "json",
                ...
                $http(req).then(function successCallback(response) {
                    ...
                    notificationsService.error("Could not check Vimeo connection Status - Try Re-Authorising");
